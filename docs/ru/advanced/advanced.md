...
> [!NOTE]
> Эта страница содержит только справочную информацию о параметрах командной строки вышестоящей среды выполнения pdf2zh-next. Она не описывает многопользовательский Web-интерфейс GBabelDocUI. Запустите GBabelDocUI командой gbabeldocui, откройте /login.html и настройте параметры перевода на странице настроек.
